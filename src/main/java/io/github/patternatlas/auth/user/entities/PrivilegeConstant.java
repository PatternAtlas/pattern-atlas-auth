...
public interface PrivilegeConstant {
    ...
    String ISSUE_VOTE                               = "ISSUE_VOTE";
    String ISSUE_EVIDENCE                           = "ISSUE_EVIDENCE";
    ...
    String ISSUE_COMMENT_ALL                        = "ISSUE_COMMENT_ALL";
    String ISSUE_VOTE_ALL                           = "ISSUE_VOTE_ALL";
    String ISSUE_EVIDENCE_ALL                       = "ISSUE_EVIDENCE_ALL";
    String ISSUE_TO_PATTERN_CANDIDATE_ALL           = "ISSUE_TO_PATTERN_CANDIDATE_ALL";
    /** CANDIDATE */
    ...
    String PATTERN_CANDIDATE_COMMENT                = "PATTERN_CANDIDATE_COMMENT";
    String PATTERN_CANDIDATE_VOTE                   = "PATTERN_CANDIDATE_VOTE";
    String PATTERN_CANDIDATE_EVIDENCE               = "PATTERN_CANDIDATE_EVIDENCE";
    ...
    String PATTERN_CANDIDATE_COMMENT_ALL            = "PATTERN_CANDIDATE_COMMENT_ALL";
    String PATTERN_CANDIDATE_VOTE_ALL               = "PATTERN_CANDIDATE_VOTE_ALL";
    String PATTERN_CANDIDATE_EVIDENCE_ALL           = "PATTERN_CANDIDATE_EVIDENCE_ALL";
    String PATTERN_CANDIDATE_TO_PATTERN_ALL         = "PATTERN_CANDIDATE_TO_PATTERN_ALL";
    /** Pattern Language */
    String PATTERN_LANGUAGE_READ                    = "PATTERN_LANGUAGE_READ";
    String PATTERN_LANGUAGE_EDIT                    = "PATTERN_LANGUAGE_EDIT";
    String PATTERN_LANGUAGE_DELETE                  = "PATTERN_LANGUAGE_DELETE";
    String PATTERN_LANGUAGE_CREATE                  = "PATTERN_LANGUAGE_CREATE";
    String PATTERN_LANGUAGE_READ_ALL                = "PATTERN_LANGUAGE_READ_ALL";
    String PATTERN_LANGUAGE_EDIT_ALL                = "PATTERN_LANGUAGE_EDIT_ALL";
    String PATTERN_LANGUAGE_DELETE_ALL              = "PATTERN_LANGUAGE_DELETE_ALL";
    /** Pattern */
